...
export const fr = {
  ...
  common: 'Commun',
  compose_new_deck: 'Composer un nouveau deck',
  composition: 'Composition',
  composition_description: 'Description de la composition',
  deck: 'Deck',
  export: 'Exporter',
  green: 'Vert',
  import: 'Importer',
  ...
  mythic: 'Mythique',
  no_deck_created: 'Aucun deck créé',
  ...
  white: 'Blanc',
  poor_pool_error:
    'Vous devez avoir au moins 4 themes dans votre collection pour composer un deck.',
